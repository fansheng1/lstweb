angular.module("myApp",['ngRoute'])
	...
	.controller("funcTrackCtrl", ['$scope', '$http', '$window',function($scope, $http, $window){
		...
		$scope.activeTaskRoutePoint = function(task_id, rs_id){
		...
		$scope.movePicture = function(dir){
			...
			if(photo_container.offsetWidth > 74*10+50){
				max_size = 10
			}else if(photo_container.offsetWidth > 74*9+35){
				max_size = 9
			}else if(photo_container.offsetWidth > 74*8+35){
				max_size = 8
